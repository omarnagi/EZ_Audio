...
class Window(QMainWindow):
    ...
    def initUI(self):
        ...
        self.Connect_button.resize(211, 49)
        self.Connect_button.move(10, 50)
        ...
        self.Download_button.resize(211, 49)
        self.Download_button.move(250, 50)
        ...
        self.Upload_button.resize(211, 49)
        self.Upload_button.move(500, 50)
        ...
        self.Sign_Out_button.resize(211, 49)
        self.Sign_Out_button.move(750, 50)
